...
class JugadorNumeritosAdmin extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.jugador-numeritos-admin')->with('numeros_temporadas', $numeros_temporadas)->with('ultimos_tres', $ultimos_tres)->with('ultimos_cincos', $ultimos_cincos)->with('juegos_totales', $juegos_totales);
    }}
