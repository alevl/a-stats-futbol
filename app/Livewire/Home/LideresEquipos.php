...
class LideresEquipos extends Component
{
    ...
    public function render()
    {
        ...
        , DB::raw('sum(jugadores_defensivas.porcentaje_fildeo) as porcentaje_fildeo')
        ...
        return view('livewire.home.lideres-equipos')->with('numeros_temporadas', $numeros_temporadas)->with('numeros_defensiva', $numeros_defensiva);
    }
