<div>
    <x-layouts.menu-admin>
        <div class="bg-gray-100 max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <span class="text-2xl font-semi-bold leading-normal">{{ __('Anotadores') }}</span>
        ...
        <x-dialog-modal wire:model="open_edit">
            ...
            <x-slot name="content">
                <div class="mb-4">
                    ...
                    <x-input wire:model.defer="anotador" type="text" class="w-full" />
                    <x-input-error for="anotador"/>
                </div>
            </x-slot>
            <x-slot name="footer">
        ...
        <x-dialog-modal wire:model="open_crear">
            ...
            <x-slot name="content">
                <div class="mb-4">
                    <x-label value="{{ __('Anotador') }}" />
                    <x-input type="text" class="w-full" wire:model.defer="anotador_crear"/>
                    <x-input-error for="anotador_crear"/>
                </div>
            </x-slot>
            <x-slot name="footer">
